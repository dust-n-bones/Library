...
public class SimpleCalendar implements  Comparable<SimpleCalendar> {
     ...
     * Δημουργεί μία ημερομηνία με βάση το έτος,
    ...
    /**
     * Δημιουργία από ημερομηνία τύπου {@code Calendar}.
     * Δημιουργεί μία ημερομηνία λαμβάνοντας
    ...
    /**
     * Επιστρέφει {@code true} αν η ημερομηνία είναι μεταγενέστερη μίας άλλης.
    ...
    /**
     * Επιστρέφει {@code true} αν η ημερομηνία είναι προγενέστερη μίας άλλης
     * @param other Η άλλη ημερομηνία
     * @return {@code true} αν η ημερομηνία είναι
    ...
    /**
     * Επιστρέφει μία ημερομηνία προσθέτοντας κάποιο αριθμό ημερών.
